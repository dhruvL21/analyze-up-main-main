...
const CANONICAL_PRODUCT_FIELDS = [
  ...
  { key: 'price', label: 'Selling Price / Retail Price (₹)', required: true, aliases: ['retail price', 'selling price', 'price', 'mrp', 'sale price', 'unit price', 'rate'] },
  ...
  { key: 'stock', label: 'Current Stock / Inventory Qty', required: true, aliases: ['current stock', 'stock', 'inventory', 'quantity', 'qty', 'units available', 'available stock', 'on hand', 'stock level', 'units'] },
  ...
  { key: 'minStock', label: 'Minimum Stock / Reorder Point', required: false, aliases: ['reorder level', 'min stock', 'minimum stock', 'reorder point', 'safety stock', 'threshold'] },
  { key: 'maxStock', label: 'Maximum Stock Capacity', required: false, aliases: ['max stock', 'maximum stock', 'capacity', 'upper limit'] },
  { key: 'supplier', label: 'Supplier / Vendor Name', required: false, aliases: ['supplier name', 'supplier', 'vendor', 'supplier / vendor', 'manufacturer', 'distributor', 'source'] },
  { key: 'supplierId', label: 'Supplier ID', required: false, aliases: ['supplier id', 'vendor id', 'sup id', 'supplier code'] },
  { key: 'leadTimeDays', label: 'Supplier Lead Time (Days)', required: false, aliases: ['lead time days', 'lead time', 'delivery days', 'procurement time', 'lead days'] },
  ...
  { key: 'city', label: 'Warehouse / Branch City', required: false, aliases: ['warehouse', 'city', 'location', 'region', 'warehouse city', 'destination', 'place', 'facility', 'hub'] },
  { key: 'status', label: 'Product Status', required: false, aliases: ['order status', 'status', 'item status', 'condition', 'state'] },
...
const CANONICAL_SALES_FIELDS = [
  ...
  { key: 'units_sold', label: 'Units Sold / Quantity', required: true, aliases: ['qty sold', 'quantity', 'units sold', 'qty', 'quantity sold', 'volume', 'units', 'pieces', 'count'] },
  ...
  { key: 'customer_id', label: 'Customer ID', required: false, aliases: ['customer id', 'client id', 'cust id', 'buyer id'] },
  { key: 'city', label: 'Customer / Shipping City', required: false, aliases: ['warehouse', 'city', 'location', 'region', 'destination', 'town', 'place', 'state', 'hub'] },
  ...
  { key: 'payment_method', label: 'Payment Mode', required: false, aliases: ['payment mode', 'payment method', 'payment', 'pay mode', 'mode of payment', 'gateway'] },
