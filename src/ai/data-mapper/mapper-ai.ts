...
const CANONICAL_PRODUCT_FIELDS = [
  { key: 'name', label: 'Product Name / Title', required: true, aliases: ['item name', 'product', 'title', 'item', 'description', 'part name', 'article', 'product_name'] },
  ...
  { key: 'price', label: 'Selling Price / Retail Price (₹)', required: true, aliases: ['selling price', 'price', 'mrp', 'retail price', 'sale price', 'unit price', 'rate'] },
  { key: 'costPrice', label: 'Cost Price / Purchase Price (₹)', required: false, aliases: ['cost price', 'cost', 'purchase price', 'buying price', 'unit cost', 'cogs', 'buy price'] },
  { key: 'stock', label: 'Current Stock / Inventory Qty', required: true, aliases: ['stock', 'inventory', 'quantity', 'qty', 'units available', 'available stock', 'on hand', 'stock level'] },
  { key: 'category', label: 'Category / Department', required: false, aliases: ['category', 'department', 'type', 'group', 'product type', 'classification', 'collection'] },
  ...
  { key: 'supplier', label: 'Supplier / Vendor Name', required: false, aliases: ['supplier', 'vendor', 'manufacturer', 'distributor', 'source'] },
  ...
  { key: 'brand', label: 'Brand Name', required: false, aliases: ['brand', 'maker'] },
...
const CANONICAL_SALES_FIELDS = [
  { key: 'product_name', label: 'Product Name Sold', required: true, aliases: ['product name', 'item', 'item title', 'product', 'description'] },
  { key: 'sku', label: 'SKU / Barcode', required: false, aliases: ['sku', 'item code', 'barcode'] },
  { key: 'units_sold', label: 'Units Sold / Quantity', required: true, aliases: ['quantity', 'units sold', 'qty', 'quantity sold', 'volume', 'qty sold'] },
  { key: 'selling_price', label: 'Unit Selling Price', required: true, aliases: ['price', 'selling price', 'rate', 'unit price', 'mrp'] },
  { key: 'cost_per_unit', label: 'Cost Per Unit', required: false, aliases: ['cost', 'cost price', 'cost per unit', 'unit cost'] },
  ...
  { key: 'order_number', label: 'Invoice / Order Number', required: false, aliases: ['invoice no', 'invoice', 'order id', 'order no', 'bill no', 'receipt'] },
  { key: 'customer_name', label: 'Customer Name', required: false, aliases: ['customer', 'client', 'buyer', 'customer name', 'account'] },
  { key: 'sale_date', label: 'Sale / Invoice Date', required: false, aliases: ['date', 'sale date', 'invoice date', 'order date', 'timestamp', 'created at'] },
  { key: 'payment_method', label: 'Payment Mode', required: false, aliases: ['payment method', 'payment mode', 'payment', 'gateway'] },
];
