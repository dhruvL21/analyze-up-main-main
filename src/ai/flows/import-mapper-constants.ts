...
export const INVENTORY_FIELDS: TargetFieldDef[] = [
  ...
  { key: 'city', label: 'Location / Warehouse City', required: false, description: 'Warehouse or branch city' },
  { key: 'status', label: 'Item Status', required: false, description: 'Active, Inactive, Discontinued' },
...
export const SALES_FIELDS: TargetFieldDef[] = [
  ...
  { key: 'city', label: 'City / Region / Location', required: false, description: 'Customer city or delivery destination' },
  { key: 'productName', label: 'Product Name / Item Name', required: true, description: 'Item or product name sold' },
  { key: 'quantity', label: 'Quantity Sold', required: true, description: 'Number of units sold' },
  { key: 'sellingPrice', label: 'Selling Price / Retail Price', required: true, description: 'Price per item at sale' },
  { key: 'costPrice', label: 'Unit Cost / Purchase Price', required: false, description: 'Historical purchase cost per unit' },
  ...
  { key: 'supplier', label: 'Supplier / Vendor / Distributor', required: false, description: 'Supplier or fulfillment vendor' },
