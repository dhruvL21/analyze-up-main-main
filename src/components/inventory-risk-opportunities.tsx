...
import { ShieldAlert, Zap, ArrowRight, AlertTriangle, Sparkles, TrendingUp, Layers } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
      ...
      <Card className="ios-glass rounded-3xl border-border/50 p-5 shadow-xl space-y-3 h-full flex flex-col justify-between">
        ...
        <Button
          ...
          className="w-full rounded-xl text-xs gap-1 border-border text-foreground hover:bg-secondary mt-3"
        >
      ...
      <Card className="ios-glass rounded-3xl border-primary/20 p-5 shadow-xl space-y-3 h-full flex flex-col justify-between">
        <div>
          <CardHeader className="p-0 pb-3 border-b border-border/40 flex flex-row items-center justify-between">
            <div className="flex items-center gap-2">
        ...
        <Button
          ...
          className="w-full rounded-xl text-xs gap-1 bg-primary text-primary-foreground font-bold shadow-md mt-3"
        >
